...
// Ajuste o path/name conforme a rota configurada no seu router.
  ...
  <div class="bg-gray-950 text-white min-h-screen font-sans antialiased">
    ...
    <header class="border-b border-gray-800 bg-gray-950 sticky top-0 z-50">
      <div class="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <button
          @click="irParaLogin"
          class="hidden md:block bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium px-4 py-2 rounded-lg transition-all duration-300 hover:scale-105 active:scale-95"
        >
          Começar agora
        </button>
      ...
      >
        <div v-if="mobileMenuOpen" class="md:hidden border-t border-gray-800 p-4 space-y-3 bg-gray-950">
          ...
          <button
            @click="irParaLogin"
            class="w-full bg-indigo-600 text-white text-sm py-2 rounded-lg transition-transform duration-300 active:scale-95"
          >
            Começar agora
          </button>
        </div>
    ...
    <section class="max-w-6xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-12 items-center">
      <div class="animate-fade-in-up">
        ...
        <button
          @click="irParaLogin"
          class="mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-medium px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-indigo-600/30 active:scale-95"
        >
          Começar agora
        </button>
      </div>
